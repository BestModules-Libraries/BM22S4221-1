...
BM22S4221_1 PIR(STATUS,&Serial1);//Please uncomment out the line of code if you use HW Serial1 on BMduino
//BM22S4221_1 PIR(STATUS,&Serial2);//Please uncomment out the line of code if you use HW Serial2 on BMduino
